...
import (
	...
	myMiddleware "github.com/NakonechniyVitalii/GoVehicleApi/internal/http-server/middleware"
	"github.com/NakonechniyVitalii/GoVehicleApi/internal/http-server/router/body_style"
	"github.com/NakonechniyVitalii/GoVehicleApi/internal/http-server/router/brand"
	"github.com/NakonechniyVitalii/GoVehicleApi/internal/http-server/router/category"
	"github.com/NakonechniyVitalii/GoVehicleApi/internal/http-server/router/driver_type"
	"github.com/NakonechniyVitalii/GoVehicleApi/internal/http-server/router/gearbox"
	"github.com/NakonechniyVitalii/GoVehicleApi/internal/http-server/router/user"
	"github.com/NakonechniyVitalii/GoVehicleApi/internal/http-server/router/vehicle"
